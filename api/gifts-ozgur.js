        ...
        const response = await fetch('https://api.x.ai/v1/responses', {
            ...
            body: JSON.stringify({
                ...
                input: [
                    {
                        role: 'system',
                        content: `Sen bir hediye uzmanısın. Sana bir kişinin profili verilecek. Bu profile en uygun 11 hediye öner. Her hediye birbirinden farklı kategoriden olsun. Sadece JSON array döndür, başka hiçbir şey yazma, markdown kullanma.
